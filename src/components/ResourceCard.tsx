  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full p-3 sm:p-4 flex items-start sm:items-center gap-2 sm:gap-4 hover:bg-accent/30 transition-colors"
      >
        ...
        <div className="flex-1 text-left min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            <code className="text-xs sm:text-sm font-mono font-medium text-foreground break-all">
              {resource.address}
            </code>
            {resource.isProduction && (
              <span className="px-1 sm:px-1.5 py-0.5 bg-risk-critical/20 text-risk-critical text-[10px] sm:text-xs font-semibold rounded">
                PROD
              </span>
            )}
            {resource.isStateful && (
              <span title="Stateful resource">
                <Database className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-muted-foreground" />
              </span>
            )}
          </div>
          <p className="text-[10px] sm:text-xs text-muted-foreground mt-0.5">{resource.type}</p>
          
          {/* Badges on mobile - show below title */}
        ...
        {/* Badges on desktop - show on right */}
        ...
        <div className="border-t border-border animate-slide-up">
          ...
          {(resource.costBefore > 0 || resource.costAfter > 0) && (
            <div className="p-3 sm:p-4 border-b border-border">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-6 text-xs sm:text-sm font-mono">
                <div>
